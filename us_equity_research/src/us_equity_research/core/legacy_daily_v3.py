...
VERSION = "us-daily-review-3"
DISCLAIMER = "本报告仅用于研究，不构成投资建议，所有事实与交易判断须由用户独立复核。"


def analyze(bundle, calendar, sec_snapshot, decision_at, fundamentals=None):
...
def write_review(bundle, calendar, sec_snapshot, decision_at, output_dir, fundamentals=None):
    packet = analyze(bundle, calendar, sec_snapshot, decision_at, fundamentals)
